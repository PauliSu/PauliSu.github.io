...
var strShapeName	= "Muodon nimi";
var strShapeText	= "Muodon teksti";
var strProps		= "Muodon tiedot";
var strResults		= "Etsi tuloksista:";

var strShape	= "Muodon nimi:";
var strNoCustomPropertiesToDisplayText = "Näytä tiedot painamalla CTRL-näppäintä ja napsauttamalla piirustuksen muotoa.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Vastaavia tietoja ei löytynyt.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Näyttää tai piilottaa muodon tiedot" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
