...
var xmlData = XMLData("visio_tiedostot/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Tämä taulukko sisältää muodon tiedot'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Otsikko</TH><TH>Arvo</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Tietoja ei ole saatavilla.";
		}
	}
